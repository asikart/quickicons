...
define('AKQUICKICONS_THUMBCACHE_PATH', 	JPath::clean(JPATH_CACHE.'/'.$params->get('thumb_cache_path', 'cache/thumbs/cache')) ) ;
define('AKQUICKICONS_THUMBCACHE_URL', 	JURI::root().$params->get('thumb_cache_path', 'cache/thumbs/cache' ) ) ;

define('AKQUICKICONS_THUMBTEMP_PATH', 	JPath::clean(JPATH_CACHE.'/'.$params->get('thumb_temp_path', 'cache/thumbs/temp')) ) ;
define('AKQUICKICONS_THUMBTEMP_URL', 		JURI::root().$params->get('thumb_temp_path', 'cache/thumbs/temp') ) ;


class AkquickiconsHelperThumb
{
	
	public static $cache_path 	= AKQUICKICONS_THUMBCACHE_PATH ;
	
	public static $cache_url 	= AKQUICKICONS_THUMBCACHE_URL ;
	
	public static $temp_path 	= AKQUICKICONS_THUMBTEMP_PATH ;
	
	public static $temp_url		= AKQUICKICONS_THUMBTEMP_URL ;
	...
	public static function getImagePath($url, $hash=null)
	{
		...
		if( $self->getHost() == $url->getHost() ){
			...
			if( !JFile::exists( $path ) ){
				AkquickiconsHelper::_('curl.getFile', (string)$url, $path);
			}
		}
