...
<fieldset class="batch">
	<legend><?php echo JText::_('COM_AKQUICKICONS_BATCH_OPTIONS');?></legend>
	<p><?php echo JText::_('COM_AKQUICKICONS_BATCH_TIP'); ?></p>
	...
	<button type="submit" onclick="Joomla.submitbutton('icon.batch');">
